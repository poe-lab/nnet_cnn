classdef (Abstract) DataDispatcher < handle
    ...
    methods (Abstract)
        ...
        % response - array of double of size [1, 1, K, N].
        %            Each response is dummified, i.e., response(i,j)=1 if
        %            observation i is in class j, and zero otherwise.
        % indices  - array of int of size [N, 1]
        %
        % Where C is the number of channels for the input image, N is the
        % number of observations in the next mini batch and K is the number
