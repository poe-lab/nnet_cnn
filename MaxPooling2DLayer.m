classdef MaxPooling2DLayer < nnet.cnn.layer.Layer
    ...
    methods(Hidden, Static)
        ...
        function this = loadobj(in)
            ...
            this = nnet.cnn.layer.MaxPooling2DLayer(internalLayer);
        end        
    end
...
if(~iPoolSizeIsGreaterThanPaddingSize(inputArguments.PoolSize, inputArguments.Padding))
    error(message('nnet_cnn:layer:MaxPooling2DLayer:PaddingSizeLargerThanOrEqualToPoolSize'));
end
end
